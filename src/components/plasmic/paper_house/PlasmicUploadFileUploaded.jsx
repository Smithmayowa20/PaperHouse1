...
import sty from "./PlasmicUploadFileUploaded.module.css"; // plasmic-import: bBY_AcH_gq/css
...
export const PlasmicUploadFileUploaded__VariantProps = new Array();

export const PlasmicUploadFileUploaded__ArgProps = new Array();

function PlasmicUploadFileUploaded__RenderFunc(props) {
                  ...
                  >
                    ...
                    >
                      ...
                      <IconsArrowRight2LineIcon
                        className={classNames(projectcss.all, sty.svg___7F7W2)}
                        role={"img"}
                      />
                    </p.Stack>
                    ...
                    >
                      ...
                      <IconsLoadingLineIcon
                        className={classNames(projectcss.all, sty.svg__eaduV)}
                        role={"img"}
                      />
                    </p.Stack>
                  </p.Stack>
                ...
                >
                  ...
                  >
                    <IconsCloseCircleLineIcon
                      className={classNames(projectcss.all, sty.svg__e99GJ)}
                      role={"img"}
                    />
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicUploadFileUploaded__ArgProps,
      internalVariantPropNames: PlasmicUploadFileUploaded__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicUploadFileUploaded__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicUploadFileUploaded";
  } else {
    func.displayName = `PlasmicUploadFileUploaded.${nodeName}`;
  }
  return func;
}

export const PlasmicUploadFileUploaded = Object.assign(
  // Top-level PlasmicUploadFileUploaded renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicUploadFileUploaded
    internalVariantProps: PlasmicUploadFileUploaded__VariantProps,
    internalArgProps: PlasmicUploadFileUploaded__ArgProps
  }
);

export default PlasmicUploadFileUploaded;
/* prettier-ignore-end */
